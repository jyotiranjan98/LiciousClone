    ...
    <Box>
        <Box  height="70PX" padding="20px">
            <Flex gap="40px" marginLeft="100px">
                ...
                <Flex><Link to="/cart"><Image src="https://www.licious.in/img/rebranding/cart_icon.svg"/></Link></Flex>
                </Flex>
            </Flex>
        </Box>
        <Box  height="100PX">
                ...
                <Flex><Link to="/chicken"><Image src="https://dao54xqhg9jfa.cloudfront.net/OMS-Category/e0442fff-f076-427c-93e2-ebd5c88c271c/original/Circle@3x-23.png?format=webp" h={"66px"}/></Link></Flex>
                <Flex><Image src="https://dao54xqhg9jfa.cloudfront.net/OMS-Category/59724ce1-1f3d-f1f4-c688-c05a0005c8de/original/Circle@3x-16.png?format=webp"/></Flex>
                <Flex><Link to="/fish"><Image src="https://dao54xqhg9jfa.cloudfront.net/OMS-Category/e13f894d-d51e-beea-4ef5-aab1a193d373/original/Circle@3x-13.png?format=webp" h={"66px"}/></Link></Flex>
